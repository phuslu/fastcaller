...
func FileLine(pc uintptr) (file string, line int32) {
...
func FileLineName(pc uintptr) (file string, line int32, name string) {
	funcInfo := findfunc(pc)
	if funcInfo.entry == nil {
		return
	}
...
func funcInfoEntry(f funcInfo) uintptr { return *f.entry }
